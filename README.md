...
- building packages for COPR
- tracking upstream releases with the GitHub Actions workflow in `.github/workflows/check-upstream.yml`
...
This is a small personal packaging repo, so the README is intentionally short.
