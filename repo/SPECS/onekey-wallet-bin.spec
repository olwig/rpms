...
npx -y @electron/asar e appdir/resources/app.asar app.asar.unpacked
...
* Tue Jul 14 2026 Olaf Wriggers <olaf@olwig.xyz> - 6.5.0-1
- Update to v6.5.0

* Sat Jun 13 2026 Olaf Wriggers <olaf@olwig.xyz> - 6.4.0-1
- Update to v6.4.0

* Tue May 19 2026 Olaf Wriggers <olaf@olwig.xyz> - 6.3.0-1
- Update to v6.3.0

* Sun Apr 19 2026 Olaf Wriggers <olaf@olwig.xyz> - 6.2.0-1
- Update to v6.2.0
- Removed suppression of app.asar extraction errors (upstream packaging issue fixed)
